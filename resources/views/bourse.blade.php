                                                ...
                                                <form action="" method="GET">
                                                    ...
                                                    <div class="justify-content-center">
                                                        ...
                                                        <div class="col-md-5">
                                                            ...
                                                            <div class="panel-heading style" style="text-align:center;font-weight:bold;"> {{$prog->intitule_programme_fr}}</div>
                                                                <div class="panel-body style" style="cursor:pointer" onClick="location='/detail_programme?id_prog={{$prog->id}}'"> 
                                                                    <div class="row">
