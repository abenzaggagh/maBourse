                                        ...
                                        <form>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="niveau" class="form-control @if ($niveau != '') form-input @endif" id="niveau">
                                                    <option disabled @if ($niveau == '') selected @endif><span>Diplôme</span></option>  
                                                ...
                                                <div style="margin: 32px 0 0px 0;">
                                                    ...
                                                    @if ($alreadyHasNotes == TRUE) 
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-input" value="{{ $bac->bacalaureat_fr }}" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <label for="annee_obtention">Année d'obtention: <span class="red">*</span></label>
                                                                    <input type="text" class="form-control form-input" value="{{ $dip->annee_obtention }}" disabled>
                                                                    </div>
                                                                
                                                                    <div class="col">
                                                                        <label for="nom">Académie d'obtention: <span class="red">*</span></label>
                                                                        <input type="text" id="academie" name="academie" class="form-control form-input" value="{{ $dip->academie_obtention }}" disabled>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col">
                                                                        ...
                                                                        <input type="text" id="note-reg" class="form-control form-input" value="{{ $bac->note_regionale }}"  disabled>
                                                                    </div>
                                                                
                                                                    <div class="col">
                                                                        <label for="nom">Note Nationale: <span class="red">*</span></label>
                                                                        <input type="text" id="note-nat" class="form-control form-input" value="{{ $bac->note_nationale }}" disabled>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div id="notes">
                                                                ...
                                                                <div class="form-group" id="notes_mat">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                        <label for="nom">Note <span id="mat-1">{{ $bac->mat_1_fr }}</span><span class="red">*</span></label>
                                                                            <input type="text" id="mat-1-input" name="mat-1" class="form-control form-input" value="{{ $bac->note_1 }}" disabled>
                                                                        </div>
                                                                        <div class="col">
                                                                            <label for="nom">Note <span id="mat-2">{{ $bac->mat_2_fr }}</span><span class="red">*</span></label>
                                                                            <input type="text" id="mat-2-input" name="mat-2" class="form-control form-input" value="{{ $bac->note_2 }}" disabled>
                                                                        </div>
                                                                        <div class="col">
                                                                            <label for="nom">Note <span id="mat-3">{{ $bac->mat_3_fr }}</span><span class="red">*</span></label>
                                                                            <input type="text" id="mat-3-input" name="mat-3" class="form-control form-input" value="{{ $bac->note_3 }}" disabled>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                {{-- 
                                                    ...
                                                    @else
                                                        <form>
                                                            <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                                                            <input type="hidden" id="has-notes" name="has_notes" value="{{ $alreadyHasNotes }}">
